    ...
    <div className="bg-white text-black shadow-md">
      <div className="container mx-auto flex justify-between items-center py-4 px-5">
        ...
        <nav className="space-x-6 hidden md:flex items-center">
          ...
          <Link href="/">
            <p
              className={`nav-link bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-600 transition-all duration-300 ${
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-lg absolute top-24 mt-2 w-full z-10">
          <nav className="flex flex-col space-y-4 px-5 py-3 ">
            ...
            <Link href="/" onClick={() => setIsMenuOpen(false)}>
              <p
                className={`nav-link bg-orange-500 text-white px-4 py-2 rounded-full hover:bg-orange-600 transition-all duration-300 ${
                  isActive("/contact") ? "active" : ""
                }`}
              >
                Liên Hệ
